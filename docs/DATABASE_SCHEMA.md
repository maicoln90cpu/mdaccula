...
| event_sources | id, type, name, url, enabled, last_scanned_at, last_seen_post_id | id | Fontes externas (sites/perfis) monitoradas automaticamente para descobrir novos eventos a publicar (substitui a antiga `news_sources`) |
