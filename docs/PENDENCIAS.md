...
**Responsável:** decisão do usuário — é uma atualização de dependência de peso real, não uma correção pontual. **Decidido em 19/08/2026: encarar** — é a Fase 2B do plano de fases seguras (flags já ativas desde a etapa 1; falta só o bump).
