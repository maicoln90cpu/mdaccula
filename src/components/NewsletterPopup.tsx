    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-2xl">🎵 Fique por dentro!</DialogTitle>
          <DialogDescription className="text-center">
            Receba as últimas notícias sobre eventos de música eletrônica, novos posts no blog e
            muito mais diretamente no seu email.
          </DialogDescription>
        </DialogHeader>
