      ...
      <div className="grid gap-4 lg:grid-cols-2">
          ...
          <CardContent className="space-y-4">
            ...
            {weeklyCfg.enabled && (
              <div className="text-xs text-muted-foreground">
                Próxima execução: <b>{dayLabels[weeklyCfg.day]} {String(weeklyCfg.hour).padStart(2, "0")}:00 BRT</b>.
              </div>
            )}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {weekendCfg.enabled && (
              <div className="text-xs text-muted-foreground">
                Próxima execução: <b>{dayLabels[weekendCfg.day]} {String(weekendCfg.hour).padStart(2, "0")}:00 BRT</b>.
              </div>
            )}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {blogCfg.enabled && (
              <div className="text-xs text-muted-foreground">
                Próxima execução: <b>{dayLabels[blogCfg.day]} {String(blogCfg.hour).padStart(2, "0")}:00 BRT</b>.
              </div>
            )}
