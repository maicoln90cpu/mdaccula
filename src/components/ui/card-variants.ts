...
export const cardVariants = cva('rounded-lg border text-card-foreground shadow-sm', {
  variants: {
    variant: {
      default: 'bg-card',
      ...
      featured:
        'bg-gradient-to-br from-primary/20 via-accent/10 to-secondary/20 border-primary/50 shadow-lg',
