  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="hidden md:inline-flex px-2 py-1 text-xs bg-muted rounded">Ctrl+K</kbd>
      </Button>
              ...
              {quickResults && quickResults.length > 0 ? (
                <CommandGroup heading="Resultados">
                  {quickResults.map((result) => (
                    <CommandItem key={result.id} onSelect={() => handleSelect(result.slug)}>
                  ...
                  <CommandItem onSelect={handleSearch}>
                    <span className="text-primary">Ver todos os resultados →</span>
                  </CommandItem>
                </CommandGroup>
              ) : (
