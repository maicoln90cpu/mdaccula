  ...
  const platforms: SharePlatform[] = [
    {
      ...
      label: 'WhatsApp',
      icon: MessageCircle,
      action: () => handleShare('whatsapp', shareLinks.whatsapp),
    },
    {
      key: 'twitter',
      label: 'Twitter',
      icon: Twitter,
      action: () => handleShare('twitter', shareLinks.twitter),
    },
    {
      key: 'facebook',
      label: 'Facebook',
      icon: Facebook,
      action: () => handleShare('facebook', shareLinks.facebook),
    },
    {
      key: 'linkedin',
      label: 'LinkedIn',
      icon: Linkedin,
      action: () => handleShare('linkedin', shareLinks.linkedin),
    },
    {
      key: 'telegram',
      label: 'Telegram',
      icon: Send,
      action: () => handleShare('telegram', shareLinks.telegram),
    },
  ];
