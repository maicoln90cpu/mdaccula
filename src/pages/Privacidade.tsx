        ...
        <main id="main-content" className="pt-16">
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      Você pode cancelar a qualquer momento clicando no link "Cancelar inscrição" no
                      rodapé de qualquer email que enviamos, ou preenchendo o formulário de exclusão
                      abaixo.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    <AccordionTrigger>Quanto tempo leva para excluir meus dados?</AccordionTrigger>
                    <AccordionContent>
                      Processamos solicitações de exclusão em até 15 dias úteis, conforme previsto na
                      LGPD. Você receberá um email de confirmação quando a exclusão for concluída.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-4">
                    <AccordionTrigger>Vocês usam cookies?</AccordionTrigger>
                    <AccordionContent>
                      Sim, usamos cookies essenciais para funcionamento do site e cookies de analytics
                      (Google Analytics e Hotjar) para entender como o site é utilizado. Você pode
                ...
                {submitted ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Você receberá um email de confirmação em breve. Processaremos sua solicitação
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground">
              <p>
                Para outras questões relacionadas à privacidade, entre em contato conosco através da{" "}
