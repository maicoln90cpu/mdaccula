...
const Contato = () => {
  ...
  const contactInfo = [
    settings.whatsapp_number && {
      ...
      link:
        settings.whatsapp_link || `https://wa.me/55${settings.whatsapp_number.replace(/\D/g, '')}`,
                  ...
                  >
                    <CardContent className="text-center p-4 sm:p-6">
                      <div className="flex justify-center mb-3 sm:mb-4">
                        <info.icon
                          className={`w-10 h-10 sm:w-12 sm:h-12 ${info.color} neon-glow group-hover:scale-110 transition-transform`}
                        />
                      </div>
                ...
                <div className="space-y-8">
                  ...
                  <Card className="card-hover">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground mb-4">
                        Estamos localizados no coração da cena eletrônica de São Paulo, sempre
                        próximos dos principais eventos e clubs da cidade.
                      </p>
                  ...
                  <Card className="card-hover bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
                    <CardContent className="p-6 text-center">
                      <h3 className="text-xl font-bold mb-4 hero-text">Contato Rápido</h3>
          ...
          <section className="py-20 bg-darker-surface">
            <div className="container mx-auto px-4">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold mb-4 hero-text">Perguntas Frequentes</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <Card className="card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Entre em contato conosco via WhatsApp ou Instagram. Somos promoters oficiais e
                      garantimos a autenticidade dos ingressos.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Sim! Trabalhamos com artistas nacionais e internacionais. Entre em contato
                      para conhecer nossas oportunidades de parceria.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Utilizamos nossas redes sociais, parcerias com influencers e nossa base de
                      seguidores fiéis para promover eventos.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Absolutamente! Somos promoters oficiais dos eventos que divulgamos. Sua
                      segurança e satisfação são nossas prioridades.
                    </p>
                  </CardContent>
                </Card>
              </div>
