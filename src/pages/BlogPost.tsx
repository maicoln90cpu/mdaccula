        ...
        <section className="py-8 sm:py-12 bg-gradient-to-r from-primary/20 to-accent/20">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <Badge className={`text-xs sm:text-sm ${getCategoryColor(post.category)}`}>
                {post.category}
              </Badge>

              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-3 sm:mt-4 mb-4 sm:mb-6 hero-text leading-tight">
                {post.title}
              </h1>
              ...
              <p className="mt-3 sm:mt-4 text-[11px] sm:text-xs text-muted-foreground/80 italic">
                Conteúdo com apoio de inteligência artificial, revisado pela equipe editorial da
                MDAccula.
              </p>
            </div>
          </div>
