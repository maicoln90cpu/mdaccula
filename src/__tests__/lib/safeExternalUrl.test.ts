...
describe('safeExternalUrl', () => {
  ...
  it('adiciona https:// quando falta protocolo (caso real do bug Vintage)', () => {
    expect(safeExternalUrl('www.sympla.com.br/vintage-culture-em-sp__3378076?afid=112122')).toBe(
      'https://www.sympla.com.br/vintage-culture-em-sp__3378076?afid=112122'
    );
  });

  it('adiciona https:// em encurtadores sem protocolo', () => {
    expect(safeExternalUrl('bit.ly/MDAccula_DEdge_listas')).toBe(
      'https://bit.ly/MDAccula_DEdge_listas'
    );
  });
