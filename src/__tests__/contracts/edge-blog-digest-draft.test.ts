/**
 * Contract test — Edge Function `blog-digest-draft`.
 *
...
const ANON_KEY =
  ...
  '';
const FN_URL = SUPABASE_URL ? `${SUPABASE_URL}/functions/v1/blog-digest-draft` : '';

describe.skipIf(!SUPABASE_URL)('Contract: blog-digest-draft', () => {
